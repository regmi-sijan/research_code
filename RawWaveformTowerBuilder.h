...
class RawWaveformTowerBuilder : public SubsysReco
{
 public:

    RawWaveformTowerBuilder(const std::string &name = "RawWaveformTowerBuilder");

  ~RawWaveformTowerBuilder() override;
  ...
  void set_detector_type(RawWaveformTowerBuilder::DetectorSystem dettype)
  {
    m_dettype = dettype;
    return;
  }
 ...
 private:
  ...
  RawWaveformTowerBuilder::DetectorSystem m_dettype;
